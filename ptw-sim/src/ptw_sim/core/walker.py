...
from ptw_sim.models.descriptor import AccessPermissions, MemoryAttributes
from ptw_sim.models.registers import RegisterState, TTBR, TCR, VTCR
from ptw_sim.core.stage1 import Stage1Walker, Stage1WalkResult
from ptw_sim.core.stage2 import Stage2Walker, Stage2WalkResult, Stage2WalkEvent
...
class PageTableWalker:
    ...
    def __init__(
        ...
        self.stage2_walker = Stage2Walker(
            ...
            output_addr_bits=register_state.vtcr_el2.pa_bits,
            granule_kb=register_state.vtcr_el2.tg0.value // 1024
        )
    ...
    def walk(
        ...
        stage1_walker = Stage1Walker(
            ...
            output_addr_bits=self.register_state.vtcr_el2.ipa_bits,
            s2_granule_kb=self.register_state.vtcr_el2.tg0.value // 1024
        )
